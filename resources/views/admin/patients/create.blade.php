@extends('layouts.master', ['sidebar'=>'patient-create'])

@section('content')
    <div class="page-header">
        <h3 class="page-title"> Patients <code>/ add patient</code></h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('admin.patient.index')}}" class="nav-link btn btn-inverse-info create-new-button">/ index</a></li>
            </ol>
        </nav>
    </div>
    <div class="row">
